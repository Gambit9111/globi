      ...
      <MainLayout>
        ...
        <div className="relative flex min-h-screen flex-col items-start overflow-hidden">
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="gradient-text mt-12 pr-28 text-3xl xl:text-8xl font-bold uppercase tracking-tighter"
          >
            Big Goals? When Results matter, Globi Delivers.
          </motion.h1>
          ...
          <motion.h2
            ...
            initial="hidden2"
            animate="visible2"
            className="mt-8 pr-20 tracking-tighter xl:text-2xl"
          >
          ...
          >
            Since 2011, Globi has been pivotal in crafting successful careers
          ...
          <h1 className="mt-16 text-lg font-bold">
            <span className="pr-1 text-color-yellow">"</span>In our firm's
            initial years, Globi quickly scaled its operations by employing
